...
class GeminiScannerService {
  ...
  Future<ReceiptData?> analyzeReceipt(
    ...
    try {
      ...
      final prompt =
          '''
Extract data from this receipt. Identify the TOTAL amount, transaction date, and a concise list of items with their quantities (e.g., "1 Air Mineral, 2 Roti Kukus"). 
...
{"amount": 55000, "date": "YYYY-MM-DD", "notes": "1 Air Mineral, 2 Roti Kukus", "category": "Food"}
''';
      ...
      if (e.message.contains('quota') || 
        ...
        throw RateLimitException('Rate limit reached. Please try scanning again later.');
      }
      rethrow;
    } catch (e, stack) {
